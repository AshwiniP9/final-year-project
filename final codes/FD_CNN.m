...
% for i = 1:kfold
% X1=[Z1(:,1:80),S1(:,1:80)];
% X2=reshape(X1',160,2*L);
% Xtrain = mat2cell(X2,rowdist1);
% 
% X1=[Z1(:,81:100),S1(:,81:100)];                 
% X2=reshape(X1',40,2*L);
% Xvalidate = mat2cell(X2,rowdist2);
% 
% confmat = 0;
% Afold = zeros(kfold,1); 
